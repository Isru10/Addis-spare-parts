...
//   // 2. Strict Role Check
//   // If user is just 'user' (not admin/superadmin/insurer), check their application status
...
//     // If pending, send to waiting room
//     if (profile.status === 'Pending') redirect("/insurer/pending");
    
//     // If rejected, maybe show error (or just redirect home for now)
