  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarContent>
        ...
        {/* 2. SPECIAL OPERATIONS GROUP (Requests & Preorders) */}
        <Collapsible defaultOpen className="group/collapsible">
          <SidebarGroup>
            <SidebarGroupLabel asChild>
              <CollapsibleTrigger>
            ...
            <CollapsibleContent>
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  {/* Special Requests (The Chat/Inquiry) */}
                  {/* Logic Fix: Only active if NOT in the sub-route /orders */}
                  <SidebarMenuItem>
                    <SidebarMenuButton 
                      asChild 
                      isActive={pathname === "/admin/requests" || (pathname.startsWith("/admin/requests/") && !pathname.includes("/orders"))}
                    >
                      <Link href="/admin/requests">
                        <MessageSquare />
                  ...
                  {/* Preorders (The Paid Import Orders) */}
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname.startsWith("/admin/requests/orders")}>
                      <Link href="/admin/requests/orders">
                        <Plane />
        ...
        <Collapsible defaultOpen className="group/collapsible">
          <SidebarGroup>
            ...
            <CollapsibleContent>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={pathname === "/admin/insurance/partners"}>
                  <Link href="/admin/insurance/partners">
                    <Users /> {/* Or Building icon */}
